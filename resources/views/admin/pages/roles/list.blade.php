    ...
    <div class="d-flex flex-column flex-column-fluid">
        <div id="kt_app_toolbar" class="app-toolbar  d-flex flex-stack py-4 py-lg-8 ">
            <div class="d-flex flex-grow-1 flex-stack flex-wrap gap-2 mb-n10" id="kt_toolbar">
                ...
                <!--begin::Button-->
                <a data-bs-toggle="modal" data-bs-target="#add_role" class="btn btn-sm btn-primary fw-bold">Add Role</a>
                <!--end::Button-->
            </div>
        </div>
        <!--begin::Content-->
                                    ...
                                    <tr>
                                        ...
                                        <td style="white-space: inherit">
                                            @foreach ($role->permissions as $permission)
                                                <span class="badge badge-success">{{ ucfirst($permission->name) }}</span>
                                            @endforeach
                                        ...
                                        <td class="Action">
                                            ...
                                            <a onclick="return confirm('are you sure to delete this role?')" href="{{ route('admins.roles.delete', ['id' => $role->id]) }}"
                                                class="btn btn-icon btn-sm me-1 btn-danger">
        ...
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content rounded">
                ...
                <div class="modal-body pt-0 pb-15 px-5 px-xl-20">
                    ...
                    <form onsubmit="showoverlay()" method="POST" action="{{ route('admins.roles.add') }}" accept-charset="UTF-8">
                        @csrf
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content rounded">
                    ...
                    <div class="modal-body pt-0 pb-15 px-5 px-xl-20">
                        ...
                        <form onsubmit="showoverlay()" method="POST" action="{{ route('admins.roles.edit', ['id' => $roleM->id]) }}" accept-charset="UTF-8">
                            @csrf
                            <div class="modal-body">
                                <div class="row">
                                    <div class="form-group">
