            ...
            <div class="d-flex flex-grow-1 flex-lg-grow-0">
                ...
                <div class="d-flex align-items-center" id="kt_app_header_logo_wrapper">
                    ...
                    <a href="{{ route('admin.dashboard') }}" class="d-flex align-items-center me-lg-20 me-5">
                        <img alt="Logo" src="{{ asset('admin_assets/logos/ehmeals_logo.png') }}"
                            style="height: 92px;" class="d-sm-none d-inline" />
                        <img alt="Logo" src="{{ asset('admin_assets/logos/ehmeals_logo.png') }}"
                            style="height: 92px;" class="theme-light-show d-none d-sm-inline" />
                ...
                <div class="app-header-menu app-header-mobile-drawer align-items-stretch" data-kt-drawer="true"
                    ...
                    <div class="menu menu-rounded menu-active-bg menu-state-primary menu-column menu-lg-row menu-title-gray-700 menu-icon-gray-500 menu-arrow-gray-500 menu-bullet-gray-500 my-5 my-lg-0 align-items-stretch fw-semibold px-2 px-lg-0"
                        ...
                        <div class="menu-item menu-lg-down-accordion me-0 me-lg-2 {{ (@$segments[1] == '') ? 'here' : '' }}">
                            <a class="menu-link py-3" href="{{ route('admin.dashboard') }}">
                                <span class="menu-title"> Dashboards</span>
                            </a>
                        </div>
                        <!-- <div class="menu-item menu-lg-down-accordion me-0 me-lg-2 {{ (@$segments[1] == 'users') ? 'here' : '' }}">
                            <a class="menu-link py-3" href="{{ route('admin.users') }}">
                                <span class="menu-title"> Users</span>
                            </a>
                        </div> -->
                        <!-- <div class="menu-item menu-lg-down-accordion me-0 me-lg-2 {{ (@$segments[1] == 'settings') ? 'here' : '' }}">
                            <a class="menu-link py-3" href="{{ route('admin.settings') }}">
                                <span class="menu-title">Settings</span>
                            </a>
                        </div> -->
                        <!-- <div class="menu-item menu-lg-down-accordion me-0 me-lg-2 {{ (@$segments[1] == 'discounts') ? 'here' : '' }}">
                            <a class="menu-link py-3" href="{{ route('admin.discount_codes') }}">
            ...
            <div class="app-navbar flex-shrink-0">
                <div class="app-navbar-item">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true" id="kt_menu_notifications">
                        <!--begin::Heading-->
                        <div class="d-flex flex-column bgi-no-repeat rounded-top" style="background-image:url('{{ asset('admin_assets/media/misc/menu-header-bg.jpg') }}')">
                            <!--begin::Title-->
                            ...
                            <div class="tab-pane fade show active" id="kt_topbar_notifications_2" role="tabpanel">
                                ...
                                <div class="d-flex flex-column px-9">
                                    ...
                                    <div class="text-center px-4">
                                        <img class="mw-100 mh-200px" alt="image" src="{{ asset('admin_assets/media/illustrations/sketchy-1/1.png') }}" />
                                    </div>
                                    <!--end::Illustration-->
                                </div>
                                <!--end::Wrapper-->
                ...
                <div class="app-navbar-item">
                    <!--begin:Info-->                    
                    <a href="/metronic8/demo35/account/billing.html" class="d-flex flex-column bg-light text-end rounded px-4 py-1 ms-3 ms-lg-6">
                    ...
                    <div class="d-flex align-items-center" data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                        ...
                        <div class="text-end d-none d-sm-flex flex-column justify-content-center me-3">
                            ...
                            <a href="../../demo35/dist/pages/user-profile/overview.html"
                                class="text-gray-800 text-hover-primary fs-7 fw-bold d-block">{{ ucfirst(auth()->user()->employee_name) }}</a>
                        </div>
                        <!--end:Info-->
                        <!--begin::User-->
                        <div class="cursor-pointer symbol symbol symbol-circle symbol-35px symbol-md-40px">
                            <!-- <img class="" src="{{ asset('storage/web_assets/media/avatars/') }}"
                                alt="user" /> -->
                            <div
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="symbol symbol-50px me-5">
                                    <!-- <img alt="Logo" src="{{ asset('storage/web_assets/media/avatars/') }}" /> -->
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Username-->
                                <div class="d-flex flex-column">
                                    <div class="fw-bold d-flex align-items-center fs-5">{{ ucfirst(auth()->user()->employee_name) }}
                                    </div>
                                    <a href="#"
                                        class="fw-semibold text-muted text-hover-primary fs-7">{{ auth()->user()->employee_email }}</a>
                                </div>
                                <!--end::Username-->
                            </div>
                        </div>
